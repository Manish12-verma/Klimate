...
const CitySearch = () => {
  ...
  return ( 
    <>
      <Button onClick={()=>{setOpen(true) }} variant={"outline"} className=" cursor-pointer relative w-full justify-start text-sm text-muted-foreground sm:pr-12  md:w-40 lg:w-64">
